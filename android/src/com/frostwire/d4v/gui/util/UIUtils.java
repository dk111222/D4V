...
package com.frostwire.d4v.gui.util;
...
import com.frostwire.d4v.core.player.EphemeralPlaylist;
...
import com.frostwire.d4v.gui.views.EditTextDialog;
...
public final class UIUtils {
    ...
    public static boolean openFile(Context context, String filePath, String mime, boolean useFileProvider) {
        try {
            ...
            if (!file.exists() && filePath.contains("Android/data/com.frostwire.d4v")) {
                // Try using the
