...
import com.frostwire.d4v.gui.views.PaymentOptionsVisibility;
import com.frostwire.d4v.gui.views.ProductCardView;
import com.frostwire.d4v.gui.views.ProductPaymentOptionsView;
import com.frostwire.d4v.offers.Offers;
import com.frostwire.d4v.offers.PlayStore;
import com.frostwire.d4v.offers.Product;
import com.frostwire.d4v.offers.Products;
...
public final class BuyActivity extends AbstractActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // from DEEP-Link House Ad pointing to app://com.frostwire.d4v/remove-ads
        Intent intent = getIntent();
        if (intent != null) {
            Uri data = intent.getData();
            if (data != null && "app://com.frostwire.d4v/remove-ads".equals(data.toString()) && cardNminutes != null) {
                cardNminutes.performClick();
            }
        }
    }
