...
package com.frostwire.d4v.gui.services;

import static com.frostwire.d4v.core.Constants.JOB_ID_ENGINE_SERVICE;
...
import com.frostwire.d4v.core.player.CoreMediaPlayer;
import com.frostwire.d4v.gui.MainApplication;
import com.frostwire.d4v.gui.services.EngineService.EngineServiceBinder;
        ...
        try {
            ...
            context.bindService(i, connection = new ServiceConnection() {
                ...
                public void onServiceConnected(ComponentName name, IBinder service) {
                    // avoids: java.lang.ClassCastException: android.os.BinderProxy cannot be cast to com.frostwire.d4v.gui.services.EngineService$EngineServiceBinder
