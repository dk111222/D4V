...
import com.frostwire.d4v.AndroidPlatform;
import com.frostwire.d4v.R;
import com.frostwire.d4v.core.ConfigurationManager;
import com.frostwire.d4v.core.Constants;
import com.frostwire.d4v.core.FWFileDescriptor;
import com.frostwire.d4v.core.MediaType;
import com.frostwire.d4v.gui.Librarian;
import com.frostwire.d4v.gui.NetworkManager;
import com.frostwire.d4v.gui.adapters.menu.CancelMenuAction;
import com.frostwire.d4v.gui.adapters.menu.CopyToClipboardMenuAction;
import com.frostwire.d4v.gui.adapters.menu.OpenMenuAction;
import com.frostwire.d4v.gui.adapters.menu.PauseDownloadMenuAction;
import com.frostwire.d4v.gui.adapters.menu.ResumeDownloadMenuAction;
import com.frostwire.d4v.gui.adapters.menu.RetryDownloadAction;
import com.frostwire.d4v.gui.adapters.menu.SeedAction;
import com.frostwire.d4v.gui.adapters.menu.SendBitcoinTipAction;
import com.frostwire.d4v.gui.adapters.menu.SendFiatTipAction;
import com.frostwire.d4v.gui.adapters.menu.StopSeedingAction;
import com.frostwire.d4v.gui.adapters.menu.TransferDetailsMenuAction;
import com.frostwire.d4v.gui.transfers.InvalidTransfer;
import com.frostwire.d4v.gui.transfers.TorrentFetcherDownload;
import com.frostwire.d4v.gui.transfers.UIBittorrentDownload;
import com.frostwire.d4v.gui.util.TransferStateStrings;
...
import com.frostwire.d4v.gui.views.MenuAdapter;
import com.frostwire.d4v.gui.views.MenuBuilder;
    ...
    private static final class OpenOnClickListener extends ClickAdapter<Context> {
        ...
        public void onClick(Context ctx, View v) {
            ...
            if (tag instanceof TransferItem) {
                ...
                if (path.getAbsolutePath().contains("Android/data/com.frostwire.d4v") && !path.exists()) {
