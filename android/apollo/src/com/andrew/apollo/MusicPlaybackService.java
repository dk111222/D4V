...
import static com.frostwire.d4v.util.RunStrict.runStrict;
...
//        notifyChange(META_CHANGED);
    ...
    public long openFile(String path) {
        ...
        // content://com.frostwire.d4v.fileprovider/external/Download/FrostWire/...audiofile.ext
        if (path.startsWith("content://com.frostwire.d4v.fileprovider/external")) {
            path = path.replace("content://com.frostwire.dv4.fileprovider/external","/storage/emulated/0");
        }
        ...
        private boolean setDataSource(TargetPlayer designatedPlayer, String path) {
            ...
            try {
                ...
                if (path.startsWith("content://")) {
                    ...
                    // /storage/emulated/0/Android/data/com.frostwire.d4v/files/FrostWire/TorrentData/...
                    try {
