        ...
        if (musicViewHolder != null) {
            ...
            if (dataHolder != null) {
                ...
                if (MusicUtils.getCurrentAudioId() == dataHolder.mItemId) {
                    musicViewHolder.mLineOne.get().setTextColor(getContext().getResources().getColor(com.frostwire.d4v.R.color.app_text_highlight));
                    musicViewHolder.mLineOneRight.get().setTextColor(getContext().getResources().getColor(com.frostwire.d4v.R.color.app_text_highlight));
                    musicViewHolder.mLineTwo.get().setTextColor(getContext().getResources().getColor(com.frostwire.d4v.R.color.app_text_highlight));
                } else {
                    musicViewHolder.mLineOne.get().setTextColor(getContext().getResources().getColor(com.frostwire.d4v.R.color.app_text_primary));
                    musicViewHolder.mLineOneRight.get().setTextColor(getContext().getResources().getColor(com.frostwire.d4v.R.color.app_text_primary));
                    musicViewHolder.mLineTwo.get().setTextColor(getContext().getResources().getColor(com.frostwire.d4v.R.color.app_text_primary));
                }
            }
        }
        return convertView;
